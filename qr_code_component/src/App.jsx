...
export default function App() {
  return (
    <div className='w-full h-[1000px] bg-light-gray flex items-center justify-center font-outfit'>
      <div className='max-w-sm h-3/5 bg-white-csm p-5 mx-auto flex flex-col gap-5 items-center rounded-2xl shadow-lg'>
